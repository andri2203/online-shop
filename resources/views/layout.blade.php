            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="relative flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="relative ml-3 group">
                        ...
                        <!-- Dropdown Menu -->
                        <div
                            class="absolute right-0 z-10 mt-2 w-48 px-2 origin-top-right rounded-md bg-gray-900 py-1 shadow-lg ring-1 ring-white/5 hidden  group-focus-within:block"
                            ...
                            @foreach($cart as $ct)
                            <span class="block px-4 py-2 text-gray-200 text-xs">{{ $ct['name'] }} x {{ $ct['quantity'] }}</span>
                            @endforeach
