...
<body class="flex flex-col flex-1 justify-center items-center min-h-screen text-gray-400 bg-gray-900">
    ...
    <section class="px-10 py-6 bg-gray-800 flex flex-col items-center">
        <h1 class="text-2xl text-center text-gray-400 mb-4">419 - Halaman kadaluarsa</h1>

        <a href="{{ route('home') }}" class="text-sm font-medium px-4 py-1.5 bg-indigo-600 text-white rounded-lg">Kembali</a>
    </section>
