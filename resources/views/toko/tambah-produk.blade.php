...
<form action="{{ route('store.tambah_produk') }}" enctype="multipart/form-data" method="post" class="grid grid-cols-2 rounded-lg w-full px-4 py-2.5 bg-gray-800 gap-y-2 gap-x-4">
    @csrf
    <div class="col-span-1 row-span-3" x-data="{ preview: null }">
